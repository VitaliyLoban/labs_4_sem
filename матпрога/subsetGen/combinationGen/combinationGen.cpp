// combinationGen.cpp: РѕРїСЂРµРґРµР»СЏРµС‚ С‚РѕС‡РєСѓ РІС…РѕРґР° РґР»СЏ РєРѕРЅСЃРѕР»СЊРЅРѕРіРѕ РїСЂРёР»РѕР¶РµРЅРёСЏ.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::cout << std::endl << "всего: " << xc.counti() << std::endl;
	system("pause");
	return 0;
}
